...
The following figures are all generated by `optimize-latex-tables` from synthetic large-language-model research data. Each style preserves the same values while changing the presentation surface.

### Classic LaTeX Style

Black-and-white manuscript style with grouped headers, booktabs-like rules, bold best values, and underlined second-best values.
...
Warm paper background with muted green highlights for README and project-page examples.
...
Pale blue styling for technical reports, model-system comparisons, and slide-ready summaries.
...
Soft lavender styling for ablation summaries and manuscript-facing overview figures.
