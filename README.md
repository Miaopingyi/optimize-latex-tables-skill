...
The following figures use the same synthetic large-language-model research data to show how a rough table can be turned into a polished presentation-ready table while preserving values.

### Original Codex Baseline

![Original Codex rough table](assets/original-codex-table.png)

### Synthetic LLM Benchmark

Sage theme with grouped headers, restrained green highlights, readable typography, and soft emphasis for important values.

![Synthetic LLM benchmark table](assets/llm-benchmark-table.png)

### Synthetic Alignment Ablation

Sage theme applied to an instruction-tuning ablation table.

![Synthetic alignment ablation table](assets/alignment-ablation-table.png)

### Additional Theme Variants

Blue and lavender variants are included for README, project-page, poster, and slide surfaces.

![Blue theme LLM benchmark table](assets/llm-benchmark-table-blue.png)

![Lavender theme alignment ablation table](assets/alignment-ablation-table-lavender.png)
