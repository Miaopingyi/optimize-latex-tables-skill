...
The following figures were generated by this skill from synthetic large-language-model research data. The examples use grouped headers, restrained color, readable typography, and soft emphasis for important values.
